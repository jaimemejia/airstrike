...
$app->get('/api/programacion_vuelo/search', function() use ($app)
{
	...
	foreach ($programaciones_vuelos_destino_ida as $programacion_vuelo_destino_ida)
	{
		$data_destinos_ida[]=array
		(
					'id_tipo_clase' => $programacion_vuelo_destino_ida->id_tipo_clase,
					'nombre_clase' => $programacion_vuelo_destino_ida->nombre_clase,
					'id_precio_clase' => $programacion_vuelo_destino_ida->id_precio_clase,
					...
					'id_capacidad_clase' => $programacion_vuelo_destino_ida->id_capacidad_clase,
					'capacidad_clase' => $programacion_vuelo_destino_ida->capacidad_clase,
					'id_programacion_vuelo' => $programacion_vuelo_destino_ida->id_programacion_vuelo,
					'avion_placa' => $programacion_vuelo_destino_ida->avion_placa,
					'fecha' => $programacion_vuelo_destino_ida->fecha,
					'codigo_vuelo' => $programacion_vuelo_destino_ida->codigo_vuelo,
					...
					'codigo_linea_aerea' => $programacion_vuelo_destino_ida->codigo_linea_aerea,
					...
					'id_horario' => $programacion_vuelo_destino_ida->id_horario,
	...
	foreach ($programaciones_vuelos_destino_regreso as $programacion_vuelo_destino_regreso)
	{
		$data_destinos_regreso[]=array
		(
			'id_tipo_clase' => $programacion_vuelo_destino_regreso->id_tipo_clase,
			'nombre_clase' => $programacion_vuelo_destino_regreso->nombre_clase,
			'id_precio_clase' => $programacion_vuelo_destino_regreso->id_precio_clase,
			...
			'id_capacidad_clase' => $programacion_vuelo_destino_regreso->id_capacidad_clase,
			'capacidad_clase' => $programacion_vuelo_destino_regreso->capacidad_clase,
			'id_programacion_vuelo' => $programacion_vuelo_destino_regreso->id_programacion_vuelo,
			'avion_placa' => $programacion_vuelo_destino_regreso->avion_placa,
			'fecha' => $programacion_vuelo_destino_regreso->fecha,
			'codigo_vuelo' => $programacion_vuelo_destino_regreso->codigo_vuelo,
			...
			'codigo_linea_aerea' => $programacion_vuelo_destino_regreso->codigo_linea_aerea,
			...
			'id_horario' => $programacion_vuelo_destino_regreso->id_horario,
